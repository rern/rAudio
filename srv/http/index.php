...
<script src="/assets/js/context.js?v=<?=$time?>"></script>
<script src="/assets/js/function.js?v=<?=$time?>"></script>
<script src="/assets/js/main.js?v=<?=$time?>"></script>
<script src="/assets/js/passive.js?v=<?=$time?>"></script>

<?php if ( file_exists( '/srv/http/data/system/equalizer' ) ) {?>
<link rel="stylesheet" href="/assets/css/equalizer.css?v=<?=$time?>">
<link rel="stylesheet" href="/assets/css/selectric.css?v=<?=$time?>">
<script src="/assets/js/equalizer.js?v=<?=$time?>"></script>
...
<link rel="stylesheet" href="/assets/css/keyboard.css?v=<?=$time?>">
...
<script src="/assets/js/keyboard.js?v=<?=$time?>"></script>
	  <?php }?>
