...
$body = [
	[
		...
		, 'setting'  => 'none'
		, 'help'     => <<< HTML
Share data across multiple rAudios for audioCD, bookmarks, lyrics, Library database, saved playlists and WebRadios.
 • Setup a network share for data with write permission.
