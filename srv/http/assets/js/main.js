...
// COMMON /////////////////////////////////////////////////////////////////////////////////////
$( '#logo, #reload, #button-library, #button-playlist' ).longtap( function() { // from info.js
	location.reload();
} );
$( '#logo' ).click( function() {
...
} ).longtap( '.mode-bookmark', function() {
	if ( G.drag ) return
...
$( '#lib-list' ).longtap( '.licoverimg',  function() {
	$this = $( '#lib-list' );
	$img = $this.find( 'img' );
