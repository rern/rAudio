...
converted from camilladsp_plot:
	- https://github.com/HEnquist/pycamilladsp-plot/blob/master/camilladsp_plot/
		...
		- filters.py
revisions:
	- convert math operations to complex function: complex_number.FUNCTION( n ).FUNCTION()...
		- Complex( 0, 1 )
				.mul( 2 * Math.PI * f / this.fs )
				.exp()
	- function arguments and callback:
		- evalFilter( name, ... )
		- evalFilterStep( index, ...)
		- replace return with graph.plotSet()
...
/**/graph.plotSet( result );
}
/**/
function evalFilterStep( index, name = "filterstep", npoints = 1000, overrides = null ) {
/**/var conf = S.config;
