/**
!!! Method getCurColorHsl: insert at >>>,this.getCurColorHsv...
,this.getCurColorHsl=function(){let t,a,r;t=l.r/255,a=l.g/255,r=l.b/255;const e=Math.max(t,a,r),n=Math.min(t,a,r);let s,c,h=(e+n)/2;if(e===n)s=c=0;else{const b=e-n;switch(c=h>.5?b/(2-e-n):b/(e+n),e){case t:s=(a-r)/b+(a<r?6:0);break;case a:s=(r-t)/b+2;break;case r:s=(t-a)/b+4}s/=6}return s=Math.round(360*s),c=Math.round(100*c),h=Math.round(100*h),{h:s,s:c,l:h}}
